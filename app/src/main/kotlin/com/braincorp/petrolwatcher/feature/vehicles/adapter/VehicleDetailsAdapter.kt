...
class VehicleDetailsAdapter(context: Context, private val data: ArrayList<Vehicle.Details>)
    : ArrayAdapter<Vehicle.Details>(context, R.layout.item_vehicle_details, R.id.txt_trim_level) {
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        fuelCapacity.text = String.format(context.getString(R.string.capacity_format),
                value.fuelCapacity)
        avgConsumptionCity.text = String.format(context.getString(R.string.avg_consumption_city_format),
                value.avgConsumptionCity) // TODO: convert to km/l
        avgConsumptionMotorway.text = String.format(context.getString(R.string.avg_consumption_motorway_format),
                value.avgConsumptionMotorway) // TODO: convert to km/l
