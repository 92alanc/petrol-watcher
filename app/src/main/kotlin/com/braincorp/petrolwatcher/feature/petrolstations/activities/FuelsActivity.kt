...
import com.braincorp.petrolwatcher.feature.petrolstations.adapters.FuelQualityAdapter
import com.braincorp.petrolwatcher.feature.petrolstations.adapters.FuelTypeAdapter
...
class FuelsActivity : AppCompatActivity(), View.OnClickListener, AdaptableUi {
    ...
    companion object {
        ...
        fun getIntent(context: Context, fuel: Fuel? = null,
            ...
            return Intent(context, FuelsActivity::class.java).putExtra(
                    EXTRA_FUEL, fuel)
    ...
    private fun populateSpinners() {
        val fuelTypeAdapter = FuelTypeAdapter(
                context = this)
        spinnerFuelType.adapter = fuelTypeAdapter

        val fuelQualityAdapter = FuelQualityAdapter(
                context = this)
