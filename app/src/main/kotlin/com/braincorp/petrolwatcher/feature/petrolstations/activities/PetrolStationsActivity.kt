package com.braincorp.petrolwatcher.feature.petrolstations.activities
...
import com.braincorp.petrolwatcher.feature.petrolstations.adapters.PetrolStationAdapter
...
class PetrolStationsActivity : AppCompatActivity(), View.OnClickListener, OnItemClickListener,
    ...
    override fun prepareInitialMode() {
        ...
        if (petrolStations == null) PetrolStationDatabase.select(valueEventListener = this)
    ...
    private fun populateRecyclerView() {
        ...
        val adapter = PetrolStationAdapter(
                context = this,
    ...
    private fun loadTopFragment() {
        if (topFragment == null || uiMode == AdaptableUi.Mode.EDIT) {
            ...
            replaceFragmentPlaceholder(R.id.placeholderTop, topFragment!!,
                                       TAG_TOP_FRAGMENT)
        }
    }
    ...
    private fun loadBottomFragment() {
        if (bottomFragment == null || uiMode == AdaptableUi.Mode.EDIT) {
            ...
            replaceFragmentPlaceholder(R.id.placeholderBottom, bottomFragment!!,
                                       TAG_BOTTOM_FRAGMENT)
        }
    }
