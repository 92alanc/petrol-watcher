...
import com.braincorp.petrolwatcher.feature.petrolstations.activities.FuelsActivity
import com.braincorp.petrolwatcher.feature.petrolstations.adapters.FuelAdapter
...
class FuelsFragment : Fragment(), View.OnClickListener, OnItemClickListener, AdaptableUi {
    ...
    private fun parseArgs() {
        val petrolStation = arguments?.getParcelable<PetrolStation>(
                ARG_PETROL_STATION)
